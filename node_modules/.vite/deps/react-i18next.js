...
var warn = (i18n, ...args) => {
  ...
  } else if ((_d = (_c = i18n == null ? void 0 : i18n.services) == null ? void 0 : _c.logger) == null ? void 0 : _d.warn) {
...
var generateComponents = (components, translation, i18n) => {
...
var useTranslation = (ns, props = {}) => {
  ...
  if ((_a = i18n.options.react) == null ? void 0 : _a.wait) warnOnce(i18n, "It seems you are still using the old wait option, you may migrate to the new useSuspense behaviour.");
  const i18nOptions = {
    ...getDefaults(),
    ...i18n.options.react,
    ...props
